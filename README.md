...
* [claude-carbon](https://github.com/gwittebolle/claude-carbon) ⭐ 190 | 🐛 0 | 🌐 Shell | 📅 2026-09-07 - An MIT-licensed Bash and SQLite tool that tracks the carbon footprint of Claude Code agent sessions, with a live CO2 estimate in the status line, per-model reports, shareable PNG report cards, and a published methodology. ![tool](https://img.shields.io/badge/tool-blue?style=flat-square)
...
* [Tracarbon](https://github.com/fvaleye/tracarbon) ⭐ 110 | 🐛 3 | 🌐 Python | 📅 2026-09-07 - Tracks a device's energy consumption and calculates carbon emissions using your location. ![tool](https://img.shields.io/badge/tool-blue?style=flat-square)
...
* [GreenScheduled](https://github.com/carbonintensityio/green-scheduler) ⭐ 17 | 🐛 24 | 🌐 Java | 📅 2026-09-07 - An Apache-2.0 Java library adding a `@GreenScheduled` annotation for Spring Boot and Quarkus that shifts jobs to the lowest-carbon hour in a window using the carbonintensity.io API. ![tool](https://img.shields.io/badge/tool-blue?style=flat-square)
...
* [scaphandre](https://github.com/hubblo-org/scaphandre) ⭐ 1,968 | 🐛 93 | 🌐 Rust | 📅 2026-07-19 - Power measurement for bare-metal hosts, Prometheus, and workloads inside Docker containers. ![tool](https://img.shields.io/badge/tool-blue?style=flat-square)
* [Kepler](https://github.com/sustainable-computing-io/kepler) ⭐ 1,564 | 🐛 49 | 🌐 Go | 📅 2026-09-07 - The Kubernetes-based Efficient Power Level Exporter uses eBPF to probe energy-related system stats and exports them as Prometheus metrics. ![tool](https://img.shields.io/badge/tool-blue?style=flat-square)
...
* [PowerJoular](https://github.com/joular/powerjoular) ⭐ 117 | 🐛 6 | 🌐 Ada | 📅 2026-09-05 - Monitors the power consumption of software and hardware components in real time. ![tool](https://img.shields.io/badge/tool-blue?style=flat-square)
...
* [CO2.js](https://github.com/thegreenwebfoundation/co2.js/) ⭐ 494 | 🐛 28 | 🌐 JavaScript | 📅 2026-09-03 - An npm module for accessing the Green Web API and estimating the carbon emissions of digital services. ![tool](https://img.shields.io/badge/tool-blue?style=flat-square)
...
* [Awesome AI Tokenomics](https://github.com/QuesmaOrg/awesome-ai-tokenomics) ⭐ 167 | 🐛 2 | 🌐 Python | 📅 2026-09-06 - Roughly 190 tools, papers, and benchmarks for monitoring, optimizing, and governing LLM token cost and waste, including an energy and carbon category. ![list](https://img.shields.io/badge/list-555?style=flat-square)
