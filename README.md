...
* [claude-carbon](https://github.com/gwittebolle/claude-carbon) ⭐ 169 | 🐛 0 | 🌐 Shell | 📅 2026-08-31 - An MIT-licensed Bash and SQLite tool that tracks the carbon footprint of Claude Code agent sessions, with a live CO2 estimate in the status line, per-model reports, shareable PNG report cards, and a published methodology. ![tool](https://img.shields.io/badge/tool-blue?style=flat-square)
...
* [kube-green](https://github.com/kube-green/kube-green) ⭐ 1,370 | 🐛 54 | 🌐 Go | 📅 2026-08-19 - An open-source Kubernetes add-on that automatically shuts down selected resources when you do not need them. ![tool](https://img.shields.io/badge/tool-blue?style=flat-square)
...
* [Creedengo (formerly ecoCode)](https://github.com/green-code-initiative/creedengo-rules-specifications) ⭐ 215 | 🐛 63 | 🌐 Java | 📅 2026-08-30 - SonarQube plugins for PHP, Python, Java, JavaScript, and more, providing static analyzers that highlight code structures with a negative ecological impact. ![tool](https://img.shields.io/badge/tool-blue?style=flat-square)
* [Tracarbon](https://github.com/fvaleye/tracarbon) ⭐ 110 | 🐛 6 | 🌐 Python | 📅 2026-08-31 - Tracks a device's energy consumption and calculates carbon emissions using your location. ![tool](https://img.shields.io/badge/tool-blue?style=flat-square)
...
* [Compute Gardener Scheduler](https://github.com/elevated-systems/compute-gardener-scheduler) ⭐ 23 | 🐛 23 | 🌐 Go | 📅 2026-08-27 An open-source Kubernetes scheduler plugin that simplifies both time and location shifting of flexible compute workloads to lower-carbon or cheaper grid hours, using real-time carbon intensity data and time-of-use prices, with workload energy budgets, Kepler power metrics, and a dry-run admission webhook to evaluate savings.
* [GreenScheduled](https://github.com/carbonintensityio/green-scheduler) ⭐ 17 | 🐛 26 | 🌐 Java | 📅 2026-08-31 - An Apache-2.0 Java library adding a `@GreenScheduled` annotation for Spring Boot and Quarkus that shifts jobs to the lowest-carbon hour in a window using the carbonintensity.io API. ![tool](https://img.shields.io/badge/tool-blue?style=flat-square)
...
* [scaphandre](https://github.com/hubblo-org/scaphandre) ⭐ 1,967 | 🐛 93 | 🌐 Rust | 📅 2026-07-19 - Power measurement for bare-metal hosts, Prometheus, and workloads inside Docker containers. ![tool](https://img.shields.io/badge/tool-blue?style=flat-square)
* [Kepler](https://github.com/sustainable-computing-io/kepler) ⭐ 1,560 | 🐛 47 | 🌐 Go | 📅 2026-08-31 - The Kubernetes-based Efficient Power Level Exporter uses eBPF to probe energy-related system stats and exports them as Prometheus metrics. ![tool](https://img.shields.io/badge/tool-blue?style=flat-square)
* [PowerJoular](https://github.com/joular/powerjoular) ⭐ 117 | 🐛 10 | 🌐 Ada | 📅 2026-08-31 - Monitors the power consumption of software and hardware components in real time. ![tool](https://img.shields.io/badge/tool-blue?style=flat-square)
...
* [PowerTOP](https://github.com/fenrus75/powertop) ⭐ 1,333 | 🐛 103 | 🌐 C++ | 📅 2026-08-18 - A Linux tool to diagnose issues with power consumption and power management. ![tool](https://img.shields.io/badge/tool-blue?style=flat-square)
...
* [CO2.js](https://github.com/thegreenwebfoundation/co2.js/) ⭐ 493 | 🐛 26 | 🌐 JavaScript | 📅 2026-08-20 - An npm module for accessing the Green Web API and estimating the carbon emissions of digital services. ![tool](https://img.shields.io/badge/tool-blue?style=flat-square)
...
* [Awesome AI Tokenomics](https://github.com/QuesmaOrg/awesome-ai-tokenomics) ⭐ 159 | 🐛 0 | 🌐 Python | 📅 2026-08-28 - Roughly 190 tools, papers, and benchmarks for monitoring, optimizing, and governing LLM token cost and waste, including an energy and carbon category. ![list](https://img.shields.io/badge/list-555?style=flat-square)
